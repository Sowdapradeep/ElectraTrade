...
type AdminTab = 'OVERVIEW' | 'TRADE' | 'INVENTORY' | 'PARTNERS' | 'SETTINGS';
...
const AdminPanel = () => {
  ...
  const getPartnerName = (id: string) => allUsers.find(u => u.id === id)?.companyName || 'Unknown Corp';
      ...
      <div className="flex items-center gap-1 bg-slate-200/50 p-1.5 rounded-2xl w-fit border border-slate-200 mb-10 overflow-x-auto no-scrollbar">
        {[
          ...
          <button
            ...
            className={`flex items-center gap-2.5 px-6 py-3 rounded-xl text-[11px] font-black uppercase tracking-widest transition-all whitespace-nowrap relative ${
              activeTab === tab.id 
            ...
            <div className="space-y-10">
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                 ...
                 <div className="flex gap-2 bg-slate-100 p-1 rounded-xl">
                    <button className="px-4 py-2 bg-white rounded-lg text-[10px] font-black uppercase text-indigo-600 shadow-sm">All Partners</button>
                    <button className="px-4 py-2 rounded-lg text-[10px] font-black uppercase text-slate-400 hover:text-slate-600">Compliance Audit</button>
                 </div>
              </div>
                    ...
                    <div className="space-y-6">
                      <div className="flex justify-between items-start">
                        ...
                        <span className={`text-[8px] font-black uppercase px-2.5 py-1 rounded-full ${
                          user.isApproved ? 'bg-green-50 text-green-600 border border-green-100' : 
